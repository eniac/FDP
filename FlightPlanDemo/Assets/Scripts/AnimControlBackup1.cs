...
// //     public float jumpRC;
// // };
// public class AnimControlBackup1 : MonoBehaviour
// {
...
//     Dictionary<string, List<float>> packetIDSequence = new Dictionary<string, List<float>>(); // PacketID, list of packet time in sequence
...
//                 // Debug.Log(pid + " : " + packetInSeq + " : " + packetIDSequence[pid][packetIDSequencePtr[pid]] + " : " + spTime + " : " + packetIDSequencePtr[pid]);
//             }
...
//             packetInSeq = false;
//             if(tpTime != -1){
//                 pid = packetByTarget[t][tpTime].packetID;
//                 if(packetIDSequencePtr[pid] >= packetIDSequence[pid].Count){
//                     packetIDSequencePtr[pid] = packetIDSequence[pid].Count - 1;
//                 }
//                 Debug.Log("Exception = " + pid + " : " + packetIDSequence[pid].Count + " : " + packetIDSequencePtr[pid]);
//                 packetInSeq = (packetIDSequencePtr[pid] >= 0  && packetIDSequence[pid][packetIDSequencePtr[pid]] == tpTime);
